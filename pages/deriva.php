      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            FECHA DE REGISTRO: <input type="date" id="fechaactual" name="fechaactual" class="form-control" style="font-size:14px; width:30%;"> <br>
                             
                  <div class="form-group">
                    <label>MOTIVO DE DERIVACIÓN (*)</label>
                    <textarea rows="2" value="" name="txtMotiDeri" class="form-control" placeholder="Por favor escriba el motivo de derivación..."></textarea>             
                  </div>
                  <div class="form-group">
                    <label>ACCIONES YA REALIZADAS (*)</label>
                    <textarea rows="2" value="" name="txtAcciRea" class="form-control" placeholder="Por favor escriba las acciones ya realizadas..."></textarea>             
                  </div>

                  <div class="form-group">
                    <label>DERIVACIÓN DEL ESTUDIANTE (*)</label>
                    <select id="lstPsicologo" name="lstPsicologo" class="form-control" style="width: 44%">  
                    <option value="NA">Seleccione un psicólogo(a)</option>
                    <?php
