<?php
  ...
  if(isset ($_POST['txtFIniEst2']) && ($_POST['txtFFinEst2']))
  {
    ...
    $sql2 = "SELECT * FROM derivacion d, estudiante e, personal p 
    WHERE d.IdEstudiante = e.IdEstudiante AND d.IdPersona = p.IdPersonal AND EstDeri = '1'
            AND d.FechDeri BETWEEN '$FIniEst' AND '$FFinEst'";
...
<head>
  ...
  <title>Reporte Derivacion | FI 2019</title>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                {       
                  ...
                  $FIncid  = $dia."/".$mes."/".$anio;  
                  if($r2["TipoDeri"] == 1){ $Area = "PSICOLOGÍA";} else{ $Area = "DIRECCIÓN"; }  
                  if($r2["AteDeri"]==0){ $Atencion = "NO ATENDIDO";  }else{ $Atencion = "ATENDIDO"; }   
                  echo '
                  <tr>    
                    <td style="vertical-align:middle;">'.$r2["IdDerivacion"].'</td>
                    ...
                    <td style="vertical-align:middle;">'.$Atencion.'</td>
              ...
              <div class="box-footer">                
                ...
                <?php 
                echo '<a class="btn btn-primary" target="_blank" href="reportes/ficha-derivacion-fecha?FIniEst='.$_POST['txtFIniEst2'].'&FFinEst='.$_POST['txtFFinEst2'].'"><img src="images/print.png"/> Imprimir</a>';
                ?>
              </div>
            </div>
            <!-- /.box-body -->
