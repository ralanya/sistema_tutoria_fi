      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-body">
            <?php            
            $sql3 = "select * from logro l where IdEstudiante = '$IdEst' and EstLog = '1'";
           
            $ejecuta3 = mysqli_query($cn,$sql3);
            $cant_inci = mysqli_num_rows($ejecuta3);
            ?>
            Datos Estudiante: <input type="text" id="archivo" name="txtAlumno" class="form-control" value="<?php echo utf8_encode($r2["ApelEst"]).', '.utf8_encode($r2["NombEst"]).' - '.utf8_encode($r2["GSEst"]); ?>" readonly="readonly" style="font-size:16px"> <br>
            Cantidad Logros: <input type="text" id="txtCantidad" name="txtCantidad" class="form-control" value="<?php echo $cant_inci; ?>" readonly="readonly" style="font-size:16px"/>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $url3="images/reporte.png";
                  echo '
                  <tr>            
                    <td style="vertical-align:middle;">'.($r3["IdLogro"]).'</td>     
                    <td style="vertical-align:middle;">'.utf8_encode($r3["DescLog"]).'</td>   
                    <td style="vertical-align:middle;">'.utf8_encode($r3["ObsLog"]).'</td>
                    <td style="vertical-align:middle;">'.$FIncid.'</td>';
                    if($Tipo==7 or $Tipo==11){
                    echo '<td style="text-align:center; vertical-align:middle;">
                    <a href="actualiza_logro?txtIdEstudiante='.$IdEst.'&txtIdLogro='.$r3["IdLogro"].'" title="Actualizar"><img src="images/actualizar.png" /></a>                      
                    </td>';
                    ?>                 

                    <td style="text-align:center; vertical-align:middle;">
                      <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="../dist/form/p_elimina_logro?txtIdLogro=<?php echo $r3["IdLogro"] ?>&txtIdEstudiante=<?php echo $IdEst;  ?>"><img src="images/eliminar.png" /></a>
                    </td>
                    <?php
                    }
                    echo '                             
              ...
              <div class="box-footer">
                ...
                <input type="hidden" id="txtIdPersonal" name="txtIdPersonal" value="<?php echo $r["IdPersonal"]; ?>" />
                <?php       
                if($Tipo==7 or $Tipo==5 or $Tipo==15){
                  echo '<a class="btn btn-primary" href="logro?txtIdEstudiante='.$IdEst.'" style="background:#1B8FB0"><img src="images/logro2.png" /> Agregar logro</a>';
                }
                ?>
