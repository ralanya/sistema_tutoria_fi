...
<div class="wrapper">
          ...
          .formulario input[type="radio"]:checked + label:before{
            ...
            <form id="FrmIncidencia" class="formulario" role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">                
                ...
                <div class="form-group">
                  ...
                  <div class="radio">                    
                    ...
                    <label for="SI" disabled>COTIDIANA</label>
                    <input name="btnradio" id="NO" type="radio" value="D" disabled>
                    <label for="NO" disabled>ESPECÍFICA</label>';
                    }
                ...
                <div class="form-group">
                  <label>DERIVADOR POR: (*)</label><br>
                    ...
                    while($rDeriva2 = mysqli_fetch_array($sqlDeriva2)){                   
                          echo '<input type="checkbox" class="minimal" value="'.$rDeriva2["IdTipoIncid"].'" name="tipoderiva2[]" disabled> '.utf8_encode($rDeriva2["NombTipoIncid"]).'<br>';
                    }
                    ?>
                    <?php
                    if($Motivo == ""){
                      echo '<input type="checkbox" class="minimal" value="" name="" onchange="habilitar(this.checked);" disabled> OTROS
                      <textarea class="form-control" rows="1" name="txtMotivo" id="txtMotivo" style="font-size:14px; width: 50%" disabled/></textarea>';
                    }
                    else{
                      echo '<input type="checkbox" class="minimal" value="" name="" onchange="habilitar(this.checked);" checked disabled> OTROS
                      <textarea class="form-control" rows="1" name="txtMotivo" id="txtMotivo" style="font-size:14px; width: 50%" disabled/>'.$Motivo.'</textarea>';
                    }
                    ?>                    
                </div> 
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="txtDescripcion" style="font-size:14px" placeholder="Por favor describa la incidencia..." required readonly="" /><?php echo utf8_encode($r2["DescIncid"]); ?></textarea>
                </div>

                <div class="form-group">
                    <label>PERSONAL QUIÉN REPORTA EL CASO (*)</label>
                    <select name="txtIdPersona" class="form-control" disabled>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="txtObservacion" style="font-size:16px" placeholder="" required readonly="" /><?php echo utf8_encode($r2["ObsIncid"]); ?></textarea>
                </div>
              ...
              <div class="box-footer">
                ...
                <input type="hidden" id="txtIdIncidencia" name="txtIdIncidencia" value="<?php echo $IdIncidencia; ?>" />
                
                <a class="btn btn-primary" target="_blank" href="reportes/ficha-incidencia?id=<?php echo $r2["IdIncidencia"]; ?>"><img src="images/print.png" /> Imprimir</a>
              </div>
            </form>
          </div>                       
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Derechos de Autor: RAC ENGINNEERS | Derechos Reservados &copy; FI 2019</strong> 
  </footer>
