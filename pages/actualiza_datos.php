        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            $("#btnDatos").on("click", function(){
                            ...
                            var ruta = "../dist/form/p_actualiza_datos.php";
                            $.ajax({
                                url: ruta,
                                type: "POST",
                                data: formData,
                                ...
                                success: function(resp){
                                    ...
                                    else if(resp!="Datos Actualizados"){
                                      alert(resp)
                                    }
            ...
            <form role="form" method="post" enctype="multipart/form-data" id="FrmDatos" autocomplete="off">
              <div class="box-body">
                <div class="form-group">
                  <label>DNI:</label>
                  <input type="text" name="txtDni" id="txtDni" class="form-control" placeholder="Por favor ingrese el DNI" value="<?php echo $r["DniPers"]; ?>" readonly/>
                </div> 
                <div class="form-group">
                  <label>Apellidos y Nombres:</label>
                  <input type="text" name="txtApatNomb" id="txtApatNomb" class="form-control" value="<?php echo utf8_encode($r["ApelPers"]).', '.utf8_encode($r["NombPers"]); ?>" readonly/>
                </div> 
                <div class="form-group">
                  <label>Cargo:</label>
                  <input type="text" name="txtCargo" id="txtCargo" class="form-control" value="<?php echo utf8_encode($r["NombTipoPers"]); ?>" readonly/>
                </div> 
                <div class="form-group">
                  <label>Contraseña:</label>
                  <input type="text" name="txtContrasena" id="txtContrasena" class="form-control" value="<?php echo SED::decryption($r["ContraPers"]); ?>" placeholder="Ingrese su Contraseña..." maxlength="8" required/>
                </div> 
              </div>
              <div class="box-footer">
                <input type="hidden" name="txtIdPersonal" id="txtIdPersonal" value="<?php echo $r["IdPersonal"]; ?>" />
                <a class="btn btn-primary" id="btnDatos">Actualiza Datos</a>
              </div>
            </form>
          </div>
        </div>
